return { 
    ...
    keys = {
        ...
        { "<leader>xb", "<CMD>BufferLineGroupClose ungrouped<CR>", desc = "Delete Non-Pinned Buffers" },
        { "<leader>xh", "<CMD>BufferLineCloseLeft<CR>", desc = "Delete Buffers to the Left" },
        { "<leader>xl", "<CMD>BufferLineCloseRight<CR>", desc = "Delete Buffers to the Right" },
